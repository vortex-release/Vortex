...
The current integration and native feature limits are documented in [the 3.27 integration notes](docs/integration-3.27.md). The periodic-stall and finish corrections are covered in [the 3.27.1 hotfix notes](docs/hotfix-3.27.1.md). The latest rendering and skeleton changes are covered in [the 3.27.2 visual notes](docs/visuals-3.27.2.md).
