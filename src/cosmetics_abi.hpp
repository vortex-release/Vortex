...
// C_EconItemView paint getter: resolves "set item texture prefab" and traverses the attribute list.
inline constexpr Function GetPaintFn{0x110F2D0,
                                     {0x48, 0x89, 0x5C, 0x24, 0x08, 0x57, 0x48, 0x83, 0xEC, 0x40, 0x8B, 0x15,
                                      0x00, 0x39, 0x4E, 0x01, 0x48, 0x8B, 0xF9, 0x65, 0x48, 0x8B, 0x04, 0x25}};
